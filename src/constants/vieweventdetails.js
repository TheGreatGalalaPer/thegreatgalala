...
export const viewEventDetails = {
  ...
  mehandi: {
    ...
    rules: [
      ...
      "Mehandi should be bought by your own.",
      "Mehandi should cover one hand.",
      "Participate can apply on their own hand or other person's hand",
      "No of Members can participate-1",
      "Mobile phones are not alllowed",
      "Participants must bring their own person if they wish to apply Mehendi on someone else.",
      "Copying or using any reference designs is strictly prohibited – violators will be disqualified.",
    ],
  },
  debate: {
    title: "Debate",
